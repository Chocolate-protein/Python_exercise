...
# 폰트 정의
game_font = pygame.font.Font(None, 40)  # .Font(폰트, 크기) : None -> defalt 폰트
...
while running:
    ...
    # .render(출력할 문장, True, 글자 색생)
    screen.blit(timer, (screen_width - 30, 10))
...
pygame.time.delay(2000)   # 게임이 바로 꺼지지 않게 함
