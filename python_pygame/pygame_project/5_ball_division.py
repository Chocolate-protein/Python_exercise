...
while running:
    ...
    # 무기 위치 조정
    weapons = [[w[0], w[1] - weapon_speed*dt] for w in weapons] # 무기 위치 위로 올리기
    # #  ==
    # for w in weapons:
    #     w[0] = w[0]
    #     w[1] = w[1] - weapon_speed * dt
    #     w = [w[0], w[1]]
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3:   # 가장 작은 공이 아니라면 공 나누기
                    # 현재 공 크기
                    ...
                    balls.append({
                        ...
                        "img_idx" : ball_idx + 1,   # 공의 이미지 인덱스
                        "to_x" : -3,   # x축 이동 방향, -3 -> 왼쪽, 3 -> 오른쪽
                        "to_y" : ball_val["to_y"] + 0.5,   # y축 이동 방향
